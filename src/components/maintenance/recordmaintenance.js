...
const AddAssetForm = ({ onSubmit, onCancel, open }) => {
    ...
    return (
        <Dialog open={open} onClose={onCancel} aria-labelledby='form-dialog-title'>
            <DialogTitle id='form-dialog-title'>Record Maintenance</DialogTitle>
            <DialogContent>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <Grid item xs={12} sm={6}>
                                <FormControl required sx={{ width: '225px' }}>
                                    ...
                                    <Select labelId='asset-label' id='assigned-vehicle-select' label='Assigned Vehicle' name='m_asset_id' value={maitenance.m_asset_id} onChange={handleChange}>
                            ...
                            <Grid item xs={12} sm={6}>
                                <FormControl required sx={{ width: '225px' }} variant='outlined'>
                                    <TextField select label='Type' name='m_type' value={maitenance.m_type} onChange={handleChange} variant='outlined'>
                            ...
                            <Grid item xs={12} sm={6}>
                                <TextField required label='Description' name='m_description' value={maitenance.m_description} onChange={handleChange} />
                            </Grid>

                            <Grid item xs={12} sm={6}>
                                <TextField sx={{ width: '225px' }} required id='status-label' label='Date' name='m_date' type='date' value={maitenance.m_date} onChange={handleChange} InputLabelProps={{ shrink: true }} />
                              </Grid>
                            ...
                            <Grid item xs={12} sm={6}>
                                <FormControl required sx={{ width: '225px' }} variant='outlined'>
                                    <TextField select label='Insurance coverage' name='m_insurance_coverage' value={maitenance.m_insurance_coverage} onChange={handleChange} variant='outlined'>
