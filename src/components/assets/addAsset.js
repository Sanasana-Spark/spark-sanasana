	...
	return (
		<Modal open={open} onClose={onCancel} sx={{ zIndex: 100 }}>
			...
			>
				...
				<TextField required label='Displacement/cc' name='a_displacement' placeholder='e.g 2000' fullWidth margin='dense' onChange={handleChange} />
				...
				<TextField required label='Reg No/Number plate' name='a_license_plate' placeholder='KCZ-0001' fullWidth margin='dense' onChange={handleChange} />

				<TextField label='Status' name='a_status' fullWidth margin='dense' onChange={handleChange} sx={{ mb: 2 }}>
				...
				<TextField required label='Insurance Expiry Date' name='a_insurance_expiry' InputLabelProps={{ shrink: true }} type='date' onChange={date => setFormData({ ...formData, insuranceExpiryDate: date })} renderInput={params => <TextField {...params} fullWidth margin='dense' />} />
