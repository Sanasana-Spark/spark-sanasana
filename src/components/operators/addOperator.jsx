				...
				<Paper className={'classes.paper'}>
					<form onSubmit={handleSubmit}>
						<Grid container spacing={2}>
							...
							<Grid item xs={12} sm={6}>
								<TextField required label='National id' name='o_national_id' value={operator.o_national_id} onChange={handleChange} />
							</Grid>
							<Grid item xs={12} sm={6}>
								<TextField required label='License Id' name='o_lincense_id' value={operator.o_lincense_id} onChange={handleChange} />
							</Grid>
							<Grid item xs={12} sm={6}>
								<TextField required label='License Type' name='o_lincense_type' value={operator.o_lincense_type} onChange={handleChange} />
							</Grid>

							<Grid item xs={12} sm={6}>
								<TextField required label='Role' name='o_role' value={operator.o_role} onChange={handleChange} />
							</Grid>

							<Grid item xs={12} sm={6}>
								<TextField required label='Experince(in years)' name='o_expirence' type='number' value={operator.o_expirence} onChange={handleChange} />
							</Grid>

							<Grid item xs={12} sm={6}>
								<TextField required abelId='status-label' label='Lincense Expiry' name='o_lincense_expiry' type='date' value={operator.o_lincense_expiry} InputLabelProps={{ shrink: true }} onChange={handleChange} />
							</Grid>

							<Grid item xs={12} sm={6}>
								<InputLabel id='status-label'>Assigned Vehicle</InputLabel>
								<Select labelId='status-label' label='Asset' name='o_assigned_asset' value={operator.o_assigned_asset} onChange={handleChange}>
							...
							<Grid item xs={12} sm={6}>
								...
								<Select labelId='status-label' label='Status' name='o_status' value={operator.o_status} onChange={handleChange}>
