...
import { Dialog, DialogTitle, DialogContent, DialogActions, Button, TextField, Grid, FormControl, FormLabel, Select, MenuItem, InputLabel } from '@mui/material';
			...
			<DialogContent>
				<form onSubmit={handleSubmit}>
							...
							<FormControl required fullWidth>
								...
								<Select labelId='asset-label' name='o_assigned_asset' value={operator.o_assigned_asset} onChange={handleChange} label='Assigned Vehicle'>
									{assetOptions.length > 0
										...
										: loading && <MenuItem disabled>Loading vehicles...</MenuItem>}
								</Select>
							</FormControl>
						</Grid>
					...
					<DialogActions>
						...
						<Button type='submit' variant='contained' disabled={isSubmitting} sx={{ backgroundColor: 'var(--secondary-color)', color: 'white' }}>
